...
4. Independent chain query: 11 distinct BlockReason codes on the mandate program.
5. Three distinct house operator pubkeys from `data/house-operators.json` each have ≥1 on-chain action.
