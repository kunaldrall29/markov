...
| Telegram Float bot | `getMe` ok: id 8751826628, username `markov_float_bot`, name `float-bot`. Local health `http://127.0.0.1:8789/health` → `tokenSet:true`. Token in gitignored `.env` only | 2026-08-27. Do not write the token in this file. |
